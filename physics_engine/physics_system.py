...
class PhysicsSystem:
    ...
    def __init__(self, physics_objects: List[PhysicsObject], physics_fields: List[PhysicsField],
                 physics_interactions: List[PhysicsInteraction]):
    ...
    def update_state(self, delta_t: float):
        for physics_object in self.physics_objects:
            ...
            if 'inert' in physics_object.properties and physics_object.properties['inert']:
            ...
            for physics_interaction in self.physics_interactions:
                for other_object in self.physics_objects:
                    if physics_object != other_object and physics_interaction.can_interact(physics_object, other_object):
